...
function(do_fetch)
  ...
  execute_process(
    COMMAND "G:/Programs/Git/cmd/git.exe" --git-dir=.git fetch --tags --force "origin"
...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "G:/Programs/Git/cmd/git.exe" --git-dir=.git rev-parse "${ref}^0"
    WORKING_DIRECTORY "G:/Qt Projects/DormitoryApp/build/Desktop_Qt_6_6_1_MinGW_64_bit-Release/_deps/ds-src"
...
execute_process(
  COMMAND "G:/Programs/Git/cmd/git.exe" --git-dir=.git show-ref "qds-4.3"
  WORKING_DIRECTORY "G:/Qt Projects/DormitoryApp/build/Desktop_Qt_6_6_1_MinGW_64_bit-Release/_deps/ds-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "G:/Programs/Git/cmd/git.exe" --git-dir=.git symbolic-ref -q HEAD
    WORKING_DIRECTORY "G:/Qt Projects/DormitoryApp/build/Desktop_Qt_6_6_1_MinGW_64_bit-Release/_deps/ds-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "G:/Programs/Git/cmd/git.exe" --git-dir=.git for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "G:/Qt Projects/DormitoryApp/build/Desktop_Qt_6_6_1_MinGW_64_bit-Release/_deps/ds-src"
...
execute_process(
  COMMAND "G:/Programs/Git/cmd/git.exe" --git-dir=.git status --porcelain
  WORKING_DIRECTORY "G:/Qt Projects/DormitoryApp/build/Desktop_Qt_6_6_1_MinGW_64_bit-Release/_deps/ds-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "G:/Programs/Git/cmd/git.exe" --git-dir=.git stash save --quiet;--include-untracked
    WORKING_DIRECTORY "G:/Qt Projects/DormitoryApp/build/Desktop_Qt_6_6_1_MinGW_64_bit-Release/_deps/ds-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "G:/Programs/Git/cmd/git.exe" --git-dir=.git checkout "${checkout_name}"
    WORKING_DIRECTORY "G:/Qt Projects/DormitoryApp/build/Desktop_Qt_6_6_1_MinGW_64_bit-Release/_deps/ds-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "G:/Programs/Git/cmd/git.exe" --git-dir=.git rebase "${checkout_name}"
    WORKING_DIRECTORY "G:/Qt Projects/DormitoryApp/build/Desktop_Qt_6_6_1_MinGW_64_bit-Release/_deps/ds-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "G:/Programs/Git/cmd/git.exe" --git-dir=.git rebase --abort
      WORKING_DIRECTORY "G:/Qt Projects/DormitoryApp/build/Desktop_Qt_6_6_1_MinGW_64_bit-Release/_deps/ds-src"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "G:/Programs/Git/cmd/git.exe" --git-dir=.git stash pop --index --quiet
          WORKING_DIRECTORY "G:/Qt Projects/DormitoryApp/build/Desktop_Qt_6_6_1_MinGW_64_bit-Release/_deps/ds-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: 'G:/Qt Projects/DormitoryApp/build/Desktop_Qt_6_6_1_MinGW_64_bit-Release/_deps/ds-src'."
    ...
    execute_process(
      COMMAND "G:/Programs/Git/cmd/git.exe" --git-dir=.git tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "G:/Programs/Git/cmd/git.exe" --git-dir=.git reset --hard --quiet
      WORKING_DIRECTORY "G:/Qt Projects/DormitoryApp/build/Desktop_Qt_6_6_1_MinGW_64_bit-Release/_deps/ds-src"
    )
    execute_process(
      COMMAND "G:/Programs/Git/cmd/git.exe" --git-dir=.git stash pop --quiet
      WORKING_DIRECTORY "G:/Qt Projects/DormitoryApp/build/Desktop_Qt_6_6_1_MinGW_64_bit-Release/_deps/ds-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "G:/Programs/Git/cmd/git.exe" --git-dir=.git reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "G:/Qt Projects/DormitoryApp/build/Desktop_Qt_6_6_1_MinGW_64_bit-Release/_deps/ds-src"
      )
      execute_process(
        COMMAND "G:/Programs/Git/cmd/git.exe" --git-dir=.git stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'G:/Qt Projects/DormitoryApp/build/Desktop_Qt_6_6_1_MinGW_64_bit-Release/_deps/ds-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
